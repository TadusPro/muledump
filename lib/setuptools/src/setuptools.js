...
setuptools.config.oclDefault = 'Exalt';
...
setuptools.data.config.rowwrap = true;
...
// helper function to debounce next two functions
...
// HANDLE RESIZE for TOTAL
$(window).on('resize.muledump.totalsWidth', debounce(function() {
    setuptools.app.muledump.totalsWidth(window.totals);
}, 1000));

// HANDLE RESIZE for ALL STAGE
$(window).on('resize.muledump.stageWidth', debounce(function() {
