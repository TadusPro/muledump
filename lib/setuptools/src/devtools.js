...
setuptools.app.devtools.ui = function() {
    ...
    setuptools.lightbox.build('devtools', ' \
        <div class="flex-container" style="flex-wrap: wrap; justify-content: center;">\
            <div class="setuptools link accountsManager menuStyle menuSmall bright textCenter m5">Accounts Manager</div>\
            <div class="setuptools link settingsManager menuStyle menuSmall bright textCenter m5">Settings Manager</div>\
            <div class="setuptools link totals menuStyle menuSmall bright textCenter m5">Totals Counter</div>\
            <div class="setuptools link groupManager menuStyle menuSmall bright textCenter m5">Group Manager</div>\
            <div class="setuptools link charlists menuStyle menuSmall bright textCenter m5">Char List Manager</div>\
