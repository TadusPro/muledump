...
setuptools.app.config.settings = function(highlight, section) {
    ...
    setuptools.lightbox.build('settings', ' \
            ...
            <div class="setuptools app config settings"> \
                <div id="settings-rowwrap">Row wrapping</div> \
                <select name="rowwrap" class="setting"> \
                    <option ' + (setuptools.data.config.rowwrap ? 'selected' : '') + ' value="yes">Yes</option> \
                    <option ' + (!setuptools.data.config.rowwrap ? 'selected' : '') + ' value="no">No</option> \
    ');
