                    ...
                    '<div class="flex-container noFlexAutoWidth" style="color:#fff;flex-flow:column;">' +
                        (large ?
                            '<div class="flex-container" style="justify-content:flex-start;">' +
                                '<div class="item noselect mr5" style="background-position:-' + large[3] + 'px -' + large[4] + 'px;border:1px solid #000;">&nbsp;</div>' +
                                '<div>' + (textures[tex1][0] || 'Default') + '</div>' +
                            '</div>' : '') +
                        (small ?
                            '<div class="flex-container" style="justify-content:flex-start;">' +
                                '<div class="item noselect mr5" style="background-position:-' + small[3] + 'px -' + small[4] + 'px;border:1px solid #000;">&nbsp;</div>' +
